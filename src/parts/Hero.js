...
export default function Hero() {
  ...
  return (
    <section className="hero w-full flex flex-col lg:flex-row items-center lg:items-start text-center lg:text-left px-4 sm:px-8 lg:px-12 mt-20 sm:mt-24 lg:mt-32">
      ...
      {/* Text Section */}
      <div className="w-full lg:w-1/2 mt-6 lg:mt-8">
      ...
      <div className="flex justify-center items-center w-full lg:w-1/2 order-first lg:order-last mt-8 lg:mt-12">
        <Fade direction="down" triggerOnce delay={175}>
